...
export default function LoginScreen() {
  ...
  const { signInWithEmail, isLoginAttemptInProgress, resetLoginAttempt } = useAuth();
          ...
          <View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={[
                  styles.input,
                  { color: textColor, borderColor: emailError ? 'red' : iconColor },
                ]}
              ...
              <View style={styles.buttonContent}>
                {isLoading ? (
                  ...
                  <>
                    ...
                    <LightModeText style={styles.loginButtonText}>Sign In</LightModeText>
                  </>
                )}
              </View>
            </TouchableOpacity>
