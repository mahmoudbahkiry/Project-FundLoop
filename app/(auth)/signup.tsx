...
const PasswordStrengthIndicator = ({ password }: { password: string }) => {
  ...
  return (
    <View style={styles.strengthContainer}>
      ...
      <LightModeText style={{ color: strength.color }}>
        {strength.label}
      </LightModeText>
    </View>
  );
...
export default function SignupScreen() {
  ...
  const [showTradingExperienceDropdown, setShowTradingExperienceDropdown] =
    useState(false);
            ...
            <LightModeView variant="card" style={styles.formContainer}>
                        ...
                        >
                          ...
                          <View style={styles.datePickerControls}>
                            ...
                            <View style={styles.datePickerColumn}>
                              <LightModeText style={styles.datePickerLabel}>
                                Year
                              </LightModeText>
              ...
              <View style={styles.inputContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setShowTradingExperienceDropdown(
